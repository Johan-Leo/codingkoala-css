...
const basicsQuestions = [
  ...
  },
  {
    ...
    answers: [
      "A collection of stylistic rules that the user agent follows when displaying an HTML document.",
      "A collection of stylistic rules.",
      "It is the code between the curly braces.",
    ],
    corAnswer: 1,
  },
  {
    question: "What is a user agent stylesheet?",
    answers: [
      "A collection of stylistic rules that the user agent follows when displaying an HTML document.",
      "A collection of stylistic rules.",
      "It is the code between the curly braces.",
  ...
  {
    question: "What is the declaration block?",
    answers: [
      "A collection of stylistic rules that the user agent follows when displaying an HTML document.",
      "A collection of stylistic rules.",
      "It is the code between the curly braces.",
...
const propertyQuestions = [
  ...
  {
    question:
      "How do you make sure an image or other object stays in it's own aspect ratio?",
    answers: ["aspect-ratio: 1/1", "object-fit: cover", "ratio: 1/1"],
    corAnswer: 1,
  },
  {
    question:
      "How do you specify what aspect ratio an image or other object should be in?",
    answers: ["aspect-ratio: 1/1", "object-fit: cover", "ratio: 1/1"],
    corAnswer: 0,
  },
  {
    question:
      "How do you change the colors of all sliders, checkboxes and input bars etc?",
    answers: [
      "accent-color: #ffffff",
      "caret-color: #ffffff",
  ...
  {
    question: "How do you change the color of the text caret?",
    answers: [
      "accent-color: #ffffff",
      "caret-color: #ffffff",
      "border-image: linear-gradient()",
  ...
  {
    question: "How do you make a gradient in a border?",
    answers: [
      "accent-color: #ffffff",
      "caret-color: #ffffff",
      "border-image: linear-gradient()",
...
const pseudoClassQuestions = [
  {
    question: "What does the :focus-visible pseudo class do?",
    answers: [
      "It gives a focus border around an element that get's triggered by either pressing tab or by clicking on the element.",
      "It gives a focus border around an element that get's triggered by pressing tab.",
      "It gives focus to an entire form container in stead of just one form item.",
    ],
    corAnswer: 1,
  },
  {
  ...
  {
    question: "What does the :focus-within pseudo class do?",
    answers: [
      "It gives a focus border around an element that get's triggered by either pressing tab or by clicking on the element.",
      "It gives a focus border around an element that get's triggered by pressing tab.",
      "It gives focus to an entire form container in stead of just one form item.",
